...
/*const customers = [
    ...
    { id: '3', name: 'Sara Bareilles', email: 'sara@gmail.com', age: 32 }
]*/
...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        customer: {
            type: CustomerType,
            args: { //Diffrerent arguments we can query the data by go here.
                id: { type: GraphQLString }
            },
            resolve(parent, args){
...
const mutation = new GraphQLObjectType({
    ...
    fields: {
        ...
        editCustomer: {
            type: CustomerType,
            args: {
                id: { type: new GraphQLNonNull(GraphQLString) }, //id is the only field that is required since customer might not want to update everything.
                name: { type: GraphQLString },
                email: { type: GraphQLString },
                age: { type: GraphQLInt }
            },
